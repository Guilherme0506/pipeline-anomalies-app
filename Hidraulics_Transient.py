...
Nt = 4*1081          # Number of time steps
dx = L / (Nx - 1)
tf = 4*60             # Total simulation time
dt = tf / (Nt - 1)
...
f = 0.021053          # Darcy-Weisbach resistance factor
...
CdA0 = 1                                  # Product of discharge coefficient and area at t=0
Q0 = 245/3600 # Flow rate at t=0
H0 = 524              # H(x=L,t=0)
...
for t in np.arange(dt, tf + dt, dt):
    ...
    H[Nx-1, n] = (a / g) * (Cmais - Q[Nx-1, n-1] / A)
